...
func resourceEdgeFunction() *schema.Resource {
	return &schema.Resource{
		...
		//
		Create: resourceEdgeFunctionCreate,
		Read:   resourceEdgeFunctionRead,
		Update: resourceEdgeFunctionUpdate,
		Delete: resourceEdgeFunctionDelete,
...
func theta_edge_function_create(d *schema.ResourceData, m any) error {
...
func resourceEdgeFunctionCreate(d *schema.ResourceData, m any) error {
	log.Print("\n\n--- CREATE ---\n\n")
	log.Printf("\n\n>>> schema.ResourceData: %+v\n\n", d)
	log.Printf("\n\n>>> meta data: %+v\n\n", m)
...
func resourceEdgeFunctionRead(d *schema.ResourceData, m any) error {
	log.Print("\n\n--- READ ---\n\n")
	log.Printf("\n\n>>> schema.ResourceData: %+v\n\n", d)
	log.Printf("\n\n>>> meta data: %+v\n\n", m)
...
func resourceEdgeFunctionUpdate(d *schema.ResourceData, m any) error {
	log.Print("\n\n--- UPDATE ---\n\n")
	log.Printf("\n\n>>> schema.ResourceData: %+v\n\n", d)
	log.Printf("\n\n>>> meta data: %+v\n\n", m)
...
func resourceEdgeFunctionDelete(d *schema.ResourceData, m any) error {
	log.Print("\n\n--- DELETE ---\n\n")
	log.Printf("\n\n>>> schema.ResourceData: %+v\n\n", d)
	log.Printf("\n\n>>> meta data: %+v\n\n", m)

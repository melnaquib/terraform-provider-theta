...
func resourceEdgeModel() *schema.Resource {
	return &schema.Resource{
		...
		//
		Create: resourceEdgeModelCreate,
		Read:   resourceEdgeModelRead,
		Update: resourceEdgeModelUpdate,
		Delete: resourceEdgeModelDelete,
...
func theta_edge_model_create(d *schema.ResourceData, m any) error {
...
func resourceEdgeModelCreate(d *schema.ResourceData, m any) error {
	log.Print("\n\n--- CREATE ---\n\n")
	log.Printf("\n\n>>> schema.ResourceData: %+v\n\n", d)
	log.Printf("\n\n>>> meta data: %+v\n\n", m)
...
func resourceEdgeModelRead(d *schema.ResourceData, m any) error {
	log.Print("\n\n--- READ ---\n\n")
	log.Printf("\n\n>>> schema.ResourceData: %+v\n\n", d)
	log.Printf("\n\n>>> meta data: %+v\n\n", m)
...
func resourceEdgeModelUpdate(d *schema.ResourceData, m any) error {
	log.Print("\n\n--- UPDATE ---\n\n")
	log.Printf("\n\n>>> schema.ResourceData: %+v\n\n", d)
	log.Printf("\n\n>>> meta data: %+v\n\n", m)
...
func resourceEdgeModelDelete(d *schema.ResourceData, m any) error {
	log.Print("\n\n--- DELETE ---\n\n")
	log.Printf("\n\n>>> schema.ResourceData: %+v\n\n", d)
	log.Printf("\n\n>>> meta data: %+v\n\n", m)

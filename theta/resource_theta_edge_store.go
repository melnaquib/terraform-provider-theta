...
func resourceEdgeStore() *schema.Resource {
	return &schema.Resource{
		...
		//
		Create: resourceEdgeStoreCreate,
		Read:   resourceEdgeStoreRead,
		Update: resourceEdgeStoreUpdate,
		Delete: resourceEdgeStoreDelete,
...
func theta_edge_store_create(d *schema.ResourceData, m any) error {
	...
	fpath :=  d.Get("path").(string);

	cmd1 := exec.Command("edgestore", "file", "--path", "", fpath);
...
func resourceEdgeStoreCreate(d *schema.ResourceData, m any) error {
	log.Print("\n\n--- CREATE ---\n\n")
	log.Printf("\n\n>>> schema.ResourceData: %+v\n\n", d)
	log.Printf("\n\n>>> meta data: %+v\n\n", m)
...
func resourceEdgeStoreRead(d *schema.ResourceData, m any) error {
	log.Print("\n\n--- READ ---\n\n")
	log.Printf("\n\n>>> schema.ResourceData: %+v\n\n", d)
	log.Printf("\n\n>>> meta data: %+v\n\n", m)
...
func resourceEdgeStoreUpdate(d *schema.ResourceData, m any) error {
	log.Print("\n\n--- UPDATE ---\n\n")
	log.Printf("\n\n>>> schema.ResourceData: %+v\n\n", d)
	log.Printf("\n\n>>> meta data: %+v\n\n", m)
...
func resourceEdgeStoreDelete(d *schema.ResourceData, m any) error {
	log.Print("\n\n--- DELETE ---\n\n")
	log.Printf("\n\n>>> schema.ResourceData: %+v\n\n", d)
	log.Printf("\n\n>>> meta data: %+v\n\n", m)

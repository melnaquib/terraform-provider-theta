...
func resourceEdgeVod() *schema.Resource {
	return &schema.Resource{
		...
		//
		Create: resourceEdgeVodCreate,
		Read:   resourceEdgeVodRead,
		Update: resourceEdgeVodUpdate,
		Delete: resourceEdgeVodDelete,
...
func theta_edge_vod_create(d *schema.ResourceData, m any) error {
...
func resourceEdgeVodCreate(d *schema.ResourceData, m any) error {
	log.Print("\n\n--- CREATE ---\n\n")
	log.Printf("\n\n>>> schema.ResourceData: %+v\n\n", d)
	log.Printf("\n\n>>> meta data: %+v\n\n", m)
...
func resourceEdgeVodRead(d *schema.ResourceData, m any) error {
	log.Print("\n\n--- READ ---\n\n")
	log.Printf("\n\n>>> schema.ResourceData: %+v\n\n", d)
	log.Printf("\n\n>>> meta data: %+v\n\n", m)
...
func resourceEdgeVodUpdate(d *schema.ResourceData, m any) error {
	log.Print("\n\n--- UPDATE ---\n\n")
	log.Printf("\n\n>>> schema.ResourceData: %+v\n\n", d)
	log.Printf("\n\n>>> meta data: %+v\n\n", m)
...
func resourceEdgeVodDelete(d *schema.ResourceData, m any) error {
	log.Print("\n\n--- DELETE ---\n\n")
	log.Printf("\n\n>>> schema.ResourceData: %+v\n\n", d)
	log.Printf("\n\n>>> meta data: %+v\n\n", m)

...
func resourceEvmContract() *schema.Resource {
	return &schema.Resource{
		...
		//
		Create: resourceEvmContractCreate,
		Read:   resourceEvmContractRead,
		Update: resourceEvmContractUpdate,
		Delete: resourceEvmContractDelete,
...
func theta_evm_contract_create(d *schema.ResourceData, m any) error {
...
func resourceEvmContractCreate(d *schema.ResourceData, m any) error {
	log.Print("\n\n--- CREATE ---\n\n")
	log.Printf("\n\n>>> schema.ResourceData: %+v\n\n", d)
	log.Printf("\n\n>>> meta data: %+v\n\n", m)
...
func resourceEvmContractRead(d *schema.ResourceData, m any) error {
	log.Print("\n\n--- READ ---\n\n")
	log.Printf("\n\n>>> schema.ResourceData: %+v\n\n", d)
	log.Printf("\n\n>>> meta data: %+v\n\n", m)
...
func resourceEvmContractUpdate(d *schema.ResourceData, m any) error {
	log.Print("\n\n--- UPDATE ---\n\n")
	log.Printf("\n\n>>> schema.ResourceData: %+v\n\n", d)
	log.Printf("\n\n>>> meta data: %+v\n\n", m)
...
func resourceEvmContractDelete(d *schema.ResourceData, m any) error {
	log.Print("\n\n--- DELETE ---\n\n")
	log.Printf("\n\n>>> schema.ResourceData: %+v\n\n", d)
	log.Printf("\n\n>>> meta data: %+v\n\n", m)
